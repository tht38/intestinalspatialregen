...
The supplemental document “Spatial_data_guide" also contains information on the replicates and accessing the data.
...
2.	Download the dataset (8 µm bin resolution or cell segmentation, cloupe.cloupe file) from GEO GSEhere
